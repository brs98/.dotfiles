...
vim.keymap.set('n', '<leader>lr', ':LspRestart<cr>', default_keymap_opts)
vim.keymap.set('n', '<leader>fp', ':let @+ = expand("%")<cr>', { silent = true, noremap = true, desc = 'Copy file path to clipboard' })
vim.keymap.set('n', '<leader>gg', ':', default_keymap_opts)
vim.keymap.set('n', '<leader>df', ':call delete(expand("%")) | bdelete!<cr>', { silent = true, noremap = true, desc = 'Delete file and buffer' })
...
vim.keymap.set('n', '<leader>cd', vim.diagnostic.open_float, { desc = 'Show [C]ode [D]iagnostic messages' })
...
vim.keymap.set('n', 's', '^', { desc = 'Move the cursor to the start of the line' })
...
require('lazy').setup({
...

  {
    ...
    init = function()
      ...
      vim.keymap.set('n', '<leader>bb', ':bdelete<cr>', default_keymap_opts)
      vim.keymap.set('n', '<leader>bp', ':BufferLineTogglePin<cr>', default_keymap_opts)
      vim.keymap.set('n', '<leader>bP', ':BufferLineGroupClose ungrouped<cr>', default_keymap_opts)
      vim.keymap.set('n', '<leader>bo', ':BufferLineCloseOthers<cr>', default_keymap_opts)
      vim.keymap.set('n', '<leader>br', ':BufferLineCloseRight<cr>', default_keymap_opts)
      vim.keymap.set('n', '<leader>bl', ':BufferLineCloseLeft<cr>', default_keymap_opts)
