...
description: Search, create, and manage notes in the work Obsidian vault with wikilinks and index notes. Use when user wants to find, create, or organize notes in their work Obsidian vault.
---
...
- **Date prefix** for meetings: `YYYY-MM-DD Topic.md`
...
type: project | decision | meeting | reference | index | dashboard
...
created: YYYY-MM-DD
date: YYYY-MM-DD               # For meetings and decisions
...
Grep pattern="project:.*Headless Rep" glob="Decisions/*.md"

# Find all meetings this month
Glob pattern="Meetings/2026-03*.md"

# Find notes by tag
Grep pattern="tags:.*sdk" glob="**/*.md"
```
...
- Cross-link between folders: a Decision should link to its Project, a Meeting should link to relevant Decisions
...
```
# By filename
Glob pattern="**/*keyword*.md" path="/Users/brandon/work/obsidian-vaults"

# By content
Grep pattern="keyword" path="/Users/brandon/work/obsidian-vaults" glob="*.md"

# By frontmatter property
Grep pattern="type: decision" path="/Users/brandon/work/obsidian-vaults"
```
...
Grep pattern="\\[\\[Note Title\\]\\]" path="/Users/brandon/work/obsidian-vaults" glob="*.md"
```

### Find index notes

```
Glob pattern="**/_Index.md" path="/Users/brandon/work/obsidian-vaults"
```
...
obsidian open path="Projects/Headless Rep App.md"
...
# Read a note
obsidian read file="Headless Rep App"
```
...
| Meeting | Meetings/ | type, attendees, project, date |
